...
<Info>
  Vocabulary knowledge is multi-dimensional{" "}
  <Tooltip text="Nation, I. S. P. (2001). Learning Vocabulary in Another Language. Cambridge: Cambridge University Press.">
    (Nation, 2001)
  </Tooltip>{" "}
  and is acquired imcrementally{" "}
  <Tooltip text="Dolch, E. W. (1927). Reading and word meanings. Ginn and company.">
    (Dolch 1927)
  </Tooltip>
  . Vocab Victor Zone captures these frameworks by carefully defining activity
  types across multiple dimensions.
</Info>
...
# Custom activity types (taxonomies)

If the activity types in your app do not fit into the above categories, you can create custom activity types by defining the unique taxonomy that describes the activity.
...
Here are the tags that make up the taxonomies for the example activity types shown above:
