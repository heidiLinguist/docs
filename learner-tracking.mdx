Vocabulary Systems respects your privacy and the privacy of your users. We do not have a way to accept any personal information about your users from you. We use your own unique learner ID to track each of your learner's progress. This allows you to leverage the benefit of the learner model without storing any personal information on our system.
...
# How learner tracking works

When you log an observation, you will include _your_ unique ID associated with the learner. This ID is unique to your app and is not shared with any other app. We use this ID to track your learner's progress and provide you with the best words for your learner's next activity.

## A private or open model: Your choice

Under your partner account settings, you can specify whether to let your users connect their data with other language learning apps (an _open model_), or quarantine our system from sharing your data with other apps (a _private model_). By default, your account is set to private.
...
- We will not share or expose the id you use to identify a learner.
- Our API provides a mechanism for removing all of a learner's data from our system, allowing you to fulfill the user's request to do so.
- Any personal information the learner provides on the Vocab Victor Zone learner dashboard will _not_ be shared with your app.
