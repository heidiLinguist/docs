...
<Info>
<Tooltip tip = "Heift, T. (2008). Modeling variability in CALL. Computer Assisted Language Learning, 21(4), 305–321.">A learner model is a description of the student’s knowledge and, in the context of intelligent tutoring, its main goal is to guide pedagogical decision-making." (Heift, 2008)</Tooltip>
</Info>
