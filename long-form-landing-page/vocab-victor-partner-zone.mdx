...
<Tooltip tip="Some example activity types: ---Learner picks the correct L1 translation for a target word--- ---Learner uses the word in a sentence--- --Learner produces the word in a puzzle game---">Here are some activity type examples</Tooltip>
