...
### Customize your learning target
...
<Tooltip Tip="Examples go here">Here are some activity type examples</Tooltip>
...
Once the model is created, you can query for zone words that are appropriate for each learner's desired activity type.
