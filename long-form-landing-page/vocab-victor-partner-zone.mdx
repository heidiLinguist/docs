...
### Zone words across multiple applications
...
Because Vocab Victor Zone lets users track their progress across multiple applications, the above sequence could happen across multiple applications, each with different strengths, letting the learner embark on a seamless learning journey!
