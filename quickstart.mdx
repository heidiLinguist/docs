...
Create a partner account at <link>. This will allow you to access the Vocab Victor Zone API and create your own learning model. There is no charge to create an account.
